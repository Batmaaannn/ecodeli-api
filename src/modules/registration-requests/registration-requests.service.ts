...
// import { Statut } from "src/types/status";
...
//       result =
//         await this.serviceAgentsService.createServiceAgent(serviceAgentDto);
...
//       result =
//         await this.deliveryAgentsService.createDeliveryAgent(deliveryAgentDto);
//     }
